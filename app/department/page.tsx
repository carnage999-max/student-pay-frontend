...
export default function DepartmentProfilePage() {
    ...
    const renderImageUploader = (
        ...
        <div className="text-center">
            ...
            <label className="relative block w-28 h-28 border border-gray-300 rounded-md overflow-hidden cursor-pointer hover:opacity-80 hover:shadow">
                <img
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            value={accountName}
                            disabled
                            className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-gray-900 bg-gray-100"
                        />
                    </div>
